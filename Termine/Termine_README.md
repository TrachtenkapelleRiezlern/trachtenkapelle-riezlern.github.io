...
Termine können direkt als Ordner gepflegt werden, oder bequem über die Excel-Datei `data/termine.xlsx`.
...
`data/termine.xlsx` öffnen, neue Zeile einfüllen, speichern und pushen.
